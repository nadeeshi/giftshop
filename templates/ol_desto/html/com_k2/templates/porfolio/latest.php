...
<div id="k2Container" class="latestView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?> ot-porfolio">
  <?php if($this->params->get('show_page_title')): ?>
  <div class="componentheading<?php echo $this->params->get('pageclass_sfx')?>"> <?php echo $this->escape($this->params->get('page_title')); ?> </div>
  <?php endif; ?>
  
  <?php foreach($this->blocks as $key=>$block): ?>
  <div class="latestItemsContainer <?php echo (($key+1)%2) ? "odd" : "even"; ?>" style="width:<?php echo number_format(99.0/$this->params->get('latestItemsCols'), 1); ?>%;">
    <?php if($this->params->get('latestItemsCols') > 1) : ?>
  	<div class="latestItemsContainerWrap">  
    <?php endif; ?>
